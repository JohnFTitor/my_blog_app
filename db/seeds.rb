...
Comment.create(post: second_post, author: second_user, text: 'Hi Jimmy!' )
Comment.create(post: second_post, author: second_user, text: 'Hi Mike!' )
Comment.create(post: third_post, author: first_user, text: 'Hi Elizabeth!' )
Comment.create(post: third_post, author: first_user, text: 'Hi Mark!' )
