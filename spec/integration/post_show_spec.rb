...
RSpec.describe 'User Show Page', type: :feature do
  describe 'User Info' do
    before :all do
      User.destroy_all
      user1 = User.create(id: 1, name: 'User-1', photo: 'user_image-1', bio: 'some1', email: 'user1@example.com',
                          password: '123456', confirmed_at: DateTime.now, posts_counter: 0)
      user2 = User.create(id: 2, name: 'User-2', photo: 'user_image-1', bio: 'some1', email: 'user2@example.com',
                          password: '123456', confirmed_at: DateTime.now, posts_counter: 0)
      @post = Post.create(id: 1, title: 'Sample Title', text: 'a' * 300, comments_counter: 0, likes_counter: 0,
                          author: user1)
      (1..5).each do |j|
