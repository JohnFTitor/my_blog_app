...
RSpec.describe 'PostsControllers', type: :request do
  before :all do
    ...
    post1 = Post.create(id: 1, author: user, title: 'Post title-1', text: 'Some text', likes_counter: 0, comments_counter: 0)
    post2 = Post.create(id: 2, author: user, title: 'Post title-2', text: 'Some text', likes_counter: 0, comments_counter: 0)
